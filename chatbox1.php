...
$sqlmsgloop = "SELECT * FROM  messages where (senderid='$_SESSION[chat1]' and reciverid='$_SESSION[profileid]') OR (senderid='$_SESSION[profileid]' and reciverid='$_SESSION[chat1]')";
