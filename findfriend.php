...
<div class="wrapper row3">
  <div id="container">
   <!-- ################################################################################################ -->
    ...
    <h2>Your friends</h2>
     <?php
            $friend= mysqli_query($con, "SELECT * from friends where profileid1!='$_SESSION[profileid]'");
			
while($rs = mysqli_fetch_array($friend))
{
	$r=mysqli_query($con, "SELECT *from profile where profile.profileid='$rs[profileid2]'");
