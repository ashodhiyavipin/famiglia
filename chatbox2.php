...
$sqlmsgloop = "SELECT * FROM  messages where (senderid='$_SESSION[chat2]' and reciverid='$_SESSION[profileid]') OR (senderid='$_SESSION[profileid]' and reciverid='$_SESSION[chat2]')";
