...
<!-- WALL POST Message ################################3 -->
<?php
//Coding updated to wallpost single user using session
$result = mysqli_query($con,"SELECT   wallpost.*, profile.* FROM wallpost LEFT JOIN profile ON wallpost.profileid = profile.profileid where wallpost.profileid='$_SESSION[profileid]' ORDER BY wallpost.postid DESC");
