...
$sqlgroup = "SELECT * FROM  groups where groupid='$_GET[groupid]' ";
$qgroup = mysqli_query($con,$sqlgroup);
$rsgroup = mysqli_fetch_array($qgroup);
?>
<!-- content -->
<div class="wrapper row3">
  <div id="container">
    ...
    <div class="one_half">
      <div id="respond">
				<?php
                $sql2 = "SELECT * FROM  groupmembers where groupid='$_GET[groupid]' ";
 				$qmsg2 = mysqli_query($con,$sql2);
  				$rsmsg2 = mysqli_fetch_array($qmsg2);
        		?>
        <h2>Posts from <?php echo $rsgroup[groupname]; ?> Group (<?php echo mysqli_num_rows($qmsg2); ?> Members)</h2>
...
<!-- WALL POST Message ################################3 -->
<?php
$result = mysqli_query($con,"SELECT   wallpost.*, profile.* FROM wallpost LEFT JOIN profile ON wallpost.profileid = profile.profileid where wallpost.groupid='$_GET[groupid]'
