...
if($_SESSION[setid] == $_GET[setid])
{
	...
	{
		$insresult =  mysqli_query($con,"INSERT INTO friends (profileid1,profileid2,requeststatus,friendtype) values('$_SESSION[profileid]','$_GET[profilereqid]','pending','Friends')");
